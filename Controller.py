...
class DroneController:
    ...
    def SetOutputs(self):       
       ...
       lv_X = sf.LinguisticVariable(Outputs_X, concept = "Speed in lateral(x) axis", universe_of_discourse = [-1.0, 1.0])
       ...
       lv_Y = sf.LinguisticVariable(Outputs_Y, concept = "Speed in vertical(y) axis", universe_of_discourse = [-1.0, 1.0])
